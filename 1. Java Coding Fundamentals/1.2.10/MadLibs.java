...
public class MadLibs {
    ...
    public static void main(String[] args) {
        ...
        // This creates a substring of the original string lib that allows us to assign a variable to the parts of speech we want to replace with words
        ...
        // This adds the new word and the start of the string to the blank string riddle, so that we can at the end print a new string with the new words
        riddle += lib.substring(0, start) + str;

        // This creates a substring of the original string lib that starts where the last substring just ended so that when we look for > and < we can find the next one and not the very first one.
        String newString = lib.substring(end + 1);
        // This sets up the variables again to allow us to find the part of speech between < and >
        start = newString.indexOf("<");
        end = newString.indexOf(">");
        // This sets the newString with a substring equal to a string called var. Var is the new part of speech that we want to replace
