...
public class GuessChecker133 {
    public static void main(String[] args) {
        ...
        if (g1 == r1) {
            System.out.println("Your first digit was a hit");
            hit += 1;
        } else {
            if (g1 == r2) {
                System.out.println("Your first digit was a near-hit");
                nearHit += 1;
            }
            if (g1 == r3) {
                System.out.println("Your first digit was a near-hit");
        ...
        if (g2 == r2) {
            System.out.println("Your second digit was a hit");
            hit += 1;
        } else {
            if (g2 == r1) {
                System.out.println("Your second digit was a near-hit");
                nearHit += 1;
            }
            if (g2 == r3) {
                System.out.println("Your second digit was a near-hit");
        ...
        if (g3 == r3) {
            System.out.println("Your third digit was a hit");
            hit += 1;
        } else {
            if (g3 == r1) {
                System.out.println("Your third digit was a near-hit");
                nearHit += 1;
            }
            if (g3 == r2) {
                System.out.println("Your third digit was a near-hit");
        ...
        if (g4 == r4) {
            System.out.println("Your fourth digit was a hit");
            hit += 1;
        } else {
            if (g4 == r1) {
                System.out.println("Your fourth digit was a near-hit");
                nearHit += 1;
            }
            if (g4 == r2) {
                System.out.println("Your fourth digit was a near-hit");
        ...
        System.out.println("Total nearly correct: " + nearHit);
    }
