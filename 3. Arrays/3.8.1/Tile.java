 ...
 * 
 * A tile is similar to a playing card and tiles are shown in 1 of 3 states: with their value (face
 * up) as hidden (face down) as matched (no long in play)
 * 
 * @author PLTW
 * @version 2.0
 */
...
public class Tile {
    ...
    /**
     * Construct a tile with a string value. The default state of a tile is hidden (face down) on
     * the board and is unmatched.
     * 
    ...
    /**
     * A matching tile to this tile has been found, set matched to true and change the way the tile
     * is shown
     */
