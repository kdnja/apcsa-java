...
public class CelebrityGame {
    ...
    /**
     * Prepares the game to start by re-initializing the celebGameList and having the gameFrame open
     * the start screen.
     */
    ...
    /**
     * Asserts that the list is initialized and contains at least one Celebrity. Sets the current
     * celebrity as the first item in the list. Opens the game play screen.
     */
    public void play() {
    ...
    /**
     * Checks that the supplied clue has at least 10 characters or is a series of clues. This method
     * would be expanded based on your subclass of Celebrity.
     * 
