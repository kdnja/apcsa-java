...
public class CelebrityPanel extends JPanel {
    ...
    /**
     * Layout manager for the panel. Uses constraints between components to align or spring from
     * edges.
     */
     ...
     * 
     * @param controller Reference to the Game passed when the CelebrityPanel is instantiated in the
     *        Frame.
     */
    ...
    /**
     * Helper method to add all components to the panel and adjust GUI settings including scroll
     * bars, and line wrap.
     */
    ...
    /**
     * Using a helper method to hold all the constraints for the GUI components in the panel
     */
    private void setupLayout() {
        ...
        panelLayout.putConstraint(SpringLayout.NORTH, guessButton, 10, SpringLayout.SOUTH,
                guessLabel);
        panelLayout.putConstraint(SpringLayout.SOUTH, guessButton, -15, SpringLayout.SOUTH, this);
        panelLayout.putConstraint(SpringLayout.NORTH, resetButton, 0, SpringLayout.NORTH,
                guessButton);
        ...
        panelLayout.putConstraint(SpringLayout.SOUTH, resetButton, 0, SpringLayout.SOUTH,
                guessButton);
        panelLayout.putConstraint(SpringLayout.NORTH, guessField, 0, SpringLayout.NORTH,
                guessLabel);
        ...
        panelLayout.putConstraint(SpringLayout.NORTH, staticTimerLabel, 15, SpringLayout.NORTH,
                resetButton);
        panelLayout.putConstraint(SpringLayout.WEST, staticTimerLabel, 10, SpringLayout.EAST,
                resetButton);
        panelLayout.putConstraint(SpringLayout.NORTH, dynamicTimerLabel, 0, SpringLayout.NORTH,
                staticTimerLabel);
        panelLayout.putConstraint(SpringLayout.WEST, dynamicTimerLabel, 5, SpringLayout.EAST,
                staticTimerLabel);
    ...
    private void setupListeners() {
        ...
        /**
         * Attaches a listener to the resetButton and uses it to call the reset method in the game.
         */
        ...
        /**
         * Attaches a listener to the guessButton and uses it to call the updateScreen method in the
         * panel.
         */
        ...
        /**
         * Attaches a listener to the guessField for enter key press and uses it to call the
    ...
    /**
     * Helper method for when the ActionListener attached to the timer fires. Sets the text of the
     * label to match the remaining time and a message at the end.
     */
    ...
    /**
     * Refactored method to allow both button and enter press in the guessField to provide the same
     * functionality.
     */
