/*
 * Activity 4.9.3 and 4.9.4 A Fishing Game
 * 
 * V1.0 10/10/2019 Copyright(c) 2019 PLTW to present. All rights reserved
 */
...
public class GameGUI extends JComponent implements ActionListener {
    ...
    /**
     * Constructor for the GameGUI class. Creates a frame with a background image and command text
     * box.
     */
    ...
    public void setupPanel() {
        ...
        // set cursor in text box, enable enter key to execute command
    ...
    public void setGameImages() {
        ...
        try {
            ...
            System.err.println("Warning: Could not open file Grid.png");
        }
        try {
    ...
    /*
     * Action listener for the execute button, invokes the execCommand method. Note: This method is
     * used by the text box and Execute button and should not be called directly.
     */
    ...
    /*
     * Manages the graphics buffer to paint inventory elements. Note: This method is for JVM use
     * only and should not be called directly. Instead call repaint() to re-render board elements.
     */
                ...
                // Other inventory items
                    ...
                    if (inventoryItem != null) {
                        if (inventoryItem.getObjectName().equals("Hook"))
                            g2.drawString(
                                    "Pow: " + ((Hook) player.getInventoryItems2D()[imgCol][imgRow])
                                            .getStrength(),
                                    px - 10, py + 43);
                        else
                            g2.drawString(
                                    "$" + player.getInventoryItems2D()[imgCol][imgRow].getCost(),
                                    px - 5, py + 43);
                    }
                }
                imgCol++;
