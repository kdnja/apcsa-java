 ...
 * Many of the attributes, methods, and programming concepts used here are
 * beyond
...
public class CakeObject {
    ...
    public CakeObject(String cakeIdentifier, int tiers) {
        this(cakeIdentifier, tiers, 0 + DEFAULT_WIDTH * getNumberOfCakes(), TABLE_HEIGHT, DEFAULT_WIDTH,
                DEFAULT_HEIGHT);
    }
    ...
    public String toString() {
        return "CakeObject: " + cakeIdentifier + " Tiers: " + tiers + " at (" + x + ", " + y + ") - Size: " + width
                + " x " + height + ">>>";
    }
