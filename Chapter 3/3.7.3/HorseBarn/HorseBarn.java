...
public class HorseBarn {
    ...
    /**
     * Constructor for the HorseBarn class. Loads data from the horsedata.txt file and populates the
     * ArrayList spaces. If a blank line occurs in the data file, the array element is assigned a
     * value of null to indicate the absence of a horse.
     */
    public HorseBarn() {
    ...
    /**
     * Returns the current list of spaces in the barn. If a space does not have a horse in it, the
